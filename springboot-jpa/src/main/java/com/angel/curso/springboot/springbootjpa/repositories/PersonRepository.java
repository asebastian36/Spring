...
public interface PersonRepository extends CrudRepository<Person, Long> {
    ...
    //  personalizadas que retornan un arreglo
    ...
    @Query("select p from Person p where p.name like  %?1%")//  % al inicio que empice con
    //   % al final que termine con, dos % que contenga
