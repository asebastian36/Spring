package com.angel.curso.springbootcrud.security.filter;

import com.angel.curso.springbootcrud.security.SimpleGrantedAuthorityJsonCreator;
...
import static com.angel.curso.springbootcrud.security.TokenJwtConfig.*;
...
public class JwtValidationFilter extends BasicAuthenticationFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        try {
            ...
            Object rolesClaims = claims.get("authorities");
